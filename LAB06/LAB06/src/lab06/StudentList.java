...
public class StudentList extends ArrayList<Student> {
    ...
    private boolean isDupplicated(String code) {
        code = code.trim().toUpperCase();
    ...
    public void addStudent() {
        ...
        System.out.println("Input the new student profile (#" + this.size() + "): ");
        
        do {            
            System.out.println("Input the id: ");
            newCode = Inputter.inputPattern("Input the code following the pattern S000: ",  "[sS][\\d]{3}");
            newCode = newCode.toUpperCase().trim();
            codeDuplicated = isDupplicated(newCode);
            if(codeDuplicated) 
